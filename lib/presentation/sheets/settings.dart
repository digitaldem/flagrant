  ...
  Widget build(BuildContext context) {
    return Consumer<SettingsProvider>(
      builder: (context, settings, _) {
        ...
        final keepAwake = settings.keepAwake;
        final fadeEnabled = settings.fadeEnabled;
        final fadeMinutes = settings.fadeMinutes;
          ...
          child: Column(
            ...
            children: [
              ...
              SwitchListTile(
                ...
                value: fadeEnabled,
                onChanged: (v) => settings.setFadeEnabled(v),
              ),
              SizedBox(height: 8),
              Padding(
              ...
              Padding(
                ...
                child: Slider.adaptive(
                  ...
                  onChanged: fadeEnabled ? (v) => settings.setFadeMinutes(v.round()) : null,
                ),
              ),
              SizedBox(height: 10),
            ],
